...
const transitTypes = computed(() => store.preferences.enabledTransitTypes)
...
function updateTransitTypes(types: TransitType[]) {
  store.updatePreference('enabledTransitTypes', types)
}
</script>
